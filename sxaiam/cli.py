...
def scan(
    ...
    console.print("[bold yellow]sxaiam[/] — scan started")
...
def report(
    ...
    console.print(f"[bold yellow]sxaiam[/] — generating report from {input}")
    console.print("\n[dim]Phase 4 (output module) not yet implemented.[/dim]")


@app.command()
def compare(
    scan_file: str = typer.Argument(..., help="Path to sxaiam scan result JSON"),
    ...
    console.print("[bold yellow]sxaiam[/] — comparing against Security Hub")
